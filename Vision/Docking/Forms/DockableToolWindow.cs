...
namespace Crom.Controls
{
    ...
    public class DockableToolWindow : Form, ITitleData
    {
        ...
        private FormBorderStyle _borderBeforeLock = FormBorderStyle.Sizable;
        ...
        /// </summary>
        internal Rectangle AutoHideButtonScreenBounds
        {
            get
            {
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            switch (message)
            {
                case SYSCOMMAND:
                    {
                        if (AutoHideButtonScreenBounds.Contains(cursorPos))
                        {
        ...
        private void OnTimer(object sender, EventArgs e)
        {
            ...
            if (AutoHideButtonScreenBounds.Contains(mousePosition))
            {
        ...
        private void DrawExtraButtons(IntPtr hWnd)
        {
            ...
            Rectangle rectAutoEcran = AutoHideButtonScreenBounds;
